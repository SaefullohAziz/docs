...
<div class="row mt-sm-4">
	...
	<div class="col-12 col-md-12 col-lg-8">
		...
		<div class="card">
			...
			{{ Form::open(['route' => ['admin.student.update', $student->id], 'files' => true, 'method' => 'put']) }}
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<fieldset>
								...
								{{ Form::bsSelect(null, __('School'), 'school_id', $schools, $student->school_id, __('Select'), ['placeholder' => __('Select'), 'required' => '']) }}
