	...
	<div class="col-12">
		...
		<div class="card card-primary">
			<div class="card-header">
				@can('create grants', 'admin')
					<a href="{{ route('admin.grant.create') }}" class="btn btn-icon btn-success" title="{{ __('Create') }}"><i class="fa fa-plus"></i></a>
				@endcan
				...
				@can('bin grants', 'admin')
					<a href="{{ route('admin.grant.bin') }}" class="btn btn-icon btn-danger" title="{{ __('Bin') }}"><i class="fas fa-trash"></i></a>
				@endcan
			</div>
			<div class="card-body">
...
<div class="modal fade" id="filterModal" tabindex="-1" role="dialog" aria-labelledby="filterModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			{{ Form::open(['route' => 'admin.grant.export', 'files' => true]) }}
