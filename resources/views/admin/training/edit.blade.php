					...
					<div class="row">
                        <div class="col-sm-6">
                            <fieldset>
                                ...
                                {{ Form::bsSelect(null, __('School'), 'school_id', $schools, $training->school_id, __('Select'), ['placeholder' => __('Select'), 'required' => '']) }}

                                {{ Form::bsSelect(null, __('Type'), 'type', $types, $training->type, __('Select'), ['placeholder' => __('Select'), 'required' => '']) }}

                                {{ Form::bsSelect(($training->type=='Basic (ToT)'||$training->type=='Adobe Photoshop'?'d-block':'d-none'), __('Implementation'), 'implementation', $implementations, $training->implementation, __('Select'), ['placeholder' => __('Select')], [__('This department is a department synchronized with ACP.')]) }}
                            </fieldset>
							...
							<fieldset class="{{ (old('type')=='Elektronika Dasar'?'d-block':'d-none') }}">
								...
								{{ Form::bsInlineRadio(null, __('Do you have assets?'), 'has_asset', ['2' => __('Already'), '1' => __('Not yet')], $training->has_asset, []) }}
							</fieldset>
							<fieldset class="{{ (old('type')=='IoT'?'d-block':'d-none') }}">
								<legend>{{ __('IoT') }}</legend>
								{{ Form::bsFile(null, __('Selection Result'), 'selection_result', $training->selection_result, [], [__('File with PDF/JPG/PNG format up to 5MB.')]) }}
							</fieldset>
                        </div>
                        <div class="col-sm-6">
							<fieldset>
							...
							<fieldset>
								...
								{{ Form::bsFile(null, __('Commitment Letter'), 'approval_letter_of_commitment_fee', $training->approval_letter_of_commitment_fee, [], [__('File with PDF format up to 5MB.')]) }}
							</fieldset>
							<fieldset>
								<legend>{{ __('Person in Charge (PIC)') }}</legend>
								{{ Form::bsText(null, __('PIC Name'), 'pic_name', $training->pic[0]->name, __('PIC Name'), ['required' => '']) }}

								{{ Form::bsText(null, __('PIC Position'), 'pic_position', $training->pic[0]->position, __('PIC Position'), ['required' => '']) }}

								{{ Form::bsPhoneNumber(null, __('PIC Phone Number'), 'pic_phone_number', $training->pic[0]->phone_number, __('PIC Phone Number'), ['maxlength' => '13', 'required' => '']) }}

								{{ Form::bsText(null, __('PIC E-Mail'), 'pic_email', $training->pic[0]->email, __('PIC E-Mail'), ['required' => '']) }}
							</fieldset>
                        </div>
					</div>
				</div>
