			...
			{{ Form::open(['route' => 'admin.school.export', 'files' => true]) }}
				<div class="modal-body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-4">
								{{ Form::bsSelect(null, __('Province'), 'province[]', $provinces, null, __('Select'), ['multiple' => '']) }}
							</div>
							<div class="col-sm-4">
								{{ Form::bsSelect(null, __('Regency'), 'regency[]', [], null, __('Select'), ['multiple' => '']) }}
							</div>
							<div class="col-sm-4">
								{{ Form::bsSelect(null, __('Level'), 'level[]', $levels, null, __('Select'), ['multiple' => '']) }}
							</div>
							<div class="col-sm-4">
								{{ Form::bsSelect(null, __('Status'), 'status', [], null, __('Select'), ['placeholder' => __('Select')]) }}
							</div>
						</div>
					</div>
				</div>
