				...
				<div class="card-body">
					<div class="row">
						<fieldset class="col-sm-6">
							...
							{{ Form::bsInlineRadio(null, __('Mikrotik Academy'), 'mikrotik_academy', ['Sudah' => 'Sudah', 'Belum' => 'Belum'], old('mikrotik_academy'), ['required' => '']) }}
						</fieldset>
						<div class="col-sm-6">
							<fieldset>
							...
							<fieldset>
								...
								{{ Form::bsInlineRadio(null, 'Apakah Kepala Sekolah telah mempelajari proposal ACP?', 'proposal', ['Sudah' => 'Sudah', 'Belum' => 'Belum'], old('mikrotik_academy'), ['required' => '']) }}
