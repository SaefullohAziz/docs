...
<div class="row mt-sm-4">
		...
		<div class="card profile-widget">
			...
			<div class="profile-widget-description">
                ...
                <dl class="row">
                    ...
                    <dd class="col-8 text-truncate">{{ $data->class->school->name }}</dd>
                    <dt class="col-4 text-truncate">{{ __('Generation') }}</dt>
                    <dd class="col-8 text-truncate">{{ $data->class->generation }}</dd>
                    <dt class="col-4 text-truncate">{{ __('School Year') }}</dt>
                    <dd class="col-8 text-truncate">{{ $data->class->school_year }}</dd>
                    <dt class="col-4 text-truncate">{{ __('Department') }}</dt>
                    <dd class="col-8 text-truncate">{{ $data->class->department->name }}</dd>
                </dl>
			</div>
		</div>
	</div>
	<div class="col-12 col-md-12 col-lg-8">
		...
		<div class="card">
			...
			{{ Form::open(['url' => route('class.student.update', ['studentClass' => $studentClass->id, 'student' => $data->id]), 'files' => true, 'method' => 'put']) }}
				<div class="card-body">
					<div class="row">
						<div class="col-sm-6">
							<fieldset>
