...
class ExamReadinessesExport implements ShouldAutoSize, WithEvents
{
    ...
    public function get()
    {
    	return ExamReadiness::list($this->request)->get()->toArray();
    }
    ...
    public function worksheets()
    {
    	return [
    		...
    		['column' => 'exam_type', 'title' => 'Type'],
    		['column' => 'sub_exam_type', 'title' => 'Sub Type'],
    		['column' => 'ma_status', 'title' => 'MA Status'],
    		['column' => 'reference_school', 'title' => 'Reference School'],
    		['column' => 'execution', 'title' => 'Execution'],
